...
from test_framework.ltc_util import get_hogex_tx, get_mweb_header
...
class MWEBP2PTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        pre_mweb_block_hash = self.generate(node, 431)[-1]
        ...
        post_mweb_block_hash = self.generate(node, 1)[0]
        ...
        post_mweb_block_hash2 = self.generate(node, 1)[0]
