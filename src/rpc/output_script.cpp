    ...
    return RPCHelpMan{
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::BOOL, "ismweb", /*optional=*/true, "If the address is an MWEB address."},
    ...
    return RPCHelpMan{"deriveaddresses",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            for (int64_t i = range_begin; i <= range_end; ++i) {
                ...
                for (const GenericAddress& dest_addr : scripts) {
                    CTxDestination dest;
                    if (!dest_addr.ExtractDestination(dest)) {
